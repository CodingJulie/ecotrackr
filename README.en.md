...
**Open-source PWA for estimating personal CO₂e**
...
**EcoTrackr** is a personal web app: log everyday activities (transport, food, energy, purchases) and see a CO₂e estimate on a dashboard. It is a pet project, not a product with an audience.

### Who it's for

- Trying a Next.js + PWA + Supabase + Web Workers stack
- Looking at how a CO₂e calculator and dashboard are put together
- Forking and extending — the repo is open
...
| **AI Insights** | Tips via Google Gemini when an API key is set; otherwise a fallback |
