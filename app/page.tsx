...
import { EMPTY_COMMUNITY_STATS } from '@/lib/community-stats';
...
function Loader() {
    ...
    return (
        <div className={`fixed inset-0 z-40 flex items-center justify-center transition-colors duration-300 ${
            mounted ? 'bg-white dark:bg-zinc-950' : 'bg-white'
        }`}>
            <MainLoader />
        </div>
    );
...
function StatsError({ message, onRetry }: { message: string; onRetry: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-40 flex flex-col items-center justify-center gap-4 bg-white dark:bg-zinc-950 px-6">
            <AlertCircle className="w-12 h-12 text-emerald-600" aria-hidden />
            <p className="text-center text-lg text-zinc-700 dark:text-zinc-300">{message}</p>
...
export default function LandingPage() {
    ...
    const [globalStats, setGlobalStats] = useState<CommunityStats>(EMPTY_COMMUNITY_STATS);
    ...
    const fetchGlobalStats = async () => {
        ...
        try {
            ...
            const stats = await response.json() as CommunityStats;
            setGlobalStats(stats);
        } catch (error) {
            console.error('Error fetching global stats:', error);
            setStatsError(t('load_error'));
        } finally {
            setIsLoading(false);
        }
    };
    ...
    useEffect(() => {
        ...
        // Initial load only; retry goes through StatsError onRetry
    ...
    const screenshotSrc = () =>
        `/screenshot-desktop-${isDark ? 'dark' : 'light'}-${i18n.language === 'ru' ? 'ru' : 'en'}.png`;
    ...
    if (statsError) {
        return <StatsError message={statsError} onRetry={fetchGlobalStats} />;
    }
            ...
            <nav className="fixed top-0 w-full bg-white/80 dark:bg-zinc-950/80 backdrop-blur-lg border-b border-zinc-200 dark:border-zinc-800 z-50">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Button variant="ghost" size="icon" onClick={toggleTheme} className="rounded-full" aria-label={isDark ? t('switch_to_light_theme') : t('switch_to_dark_theme')}>
            ...
            <section className="pt-32 pb-20 px-6 relative">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <Link href="/demo">
                            <Button
                                size="lg"
                                variant="outline"
                                className="text-lg px-10 py-7 rounded-2xl dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800"
                ...
                <div className="mt-16 max-w-5xl mx-auto px-4">
                    ...
                    >
                        <Image
                            src={screenshotSrc()}
                            alt={t('landing.hero.preview_title')}
                            width={1920}
                            height={1080}
                            priority
                ...
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-3xl font-bold">{formatCo2e(globalStats.totalCo2e, 0)}</p>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-3xl font-bold">{globalStats.treesEquivalent.toLocaleString()}</p>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-3xl font-bold">
                                {globalStats.co2ReductionKg >= 1000
                                    ? `${formatCo2eTons(globalStats.co2ReductionKg)}${t('ton_short')}`
                                    : `${formatCo2e(globalStats.co2ReductionKg, 0)} ${t('kg')}`}
                            </p>
                ...
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-xl text-emerald-100/80 max-w-2xl mx-auto mb-12">
                        {t('landing.impact.description', {
                            co2: formatCo2eTons(globalStats.totalCo2e),
                            trees: globalStats.treesEquivalent.toLocaleString()
                        })}
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        ...
                        <Card className="bg-white/10 border-white/20 text-white hover:bg-white/15 transition-all">
                            <CardContent className="pt-8 pb-8 text-center">
                                ...
                                <div className="text-5xl font-bold mb-3">{formatCo2eTons(globalStats.totalCo2e)}{t('ton_short')}</div>
                        ...
                        <Card className="bg-white/10 border-white/20 text-white hover:bg-white/15 transition-all">
                            <CardContent className="pt-8 pb-8 text-center">
                                ...
                                <div className="text-5xl font-bold mb-3">{globalStats.treesEquivalent.toLocaleString()}</div>
                    ...
                    <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                        ...
                        <div className="text-center">
                            <div className="text-2xl font-bold text-emerald-400">
                                {globalStats.co2ReductionPercent === null || globalStats.co2ReductionPercent <= 0
                                    ? '—'
                                    : `-${globalStats.co2ReductionPercent}%`}
                            </div>
                        ...
                        <div className="text-center">
                            <div className="text-2xl font-bold text-emerald-400">
                                {globalStats.totalUsers > 0
                                    ? `${globalStats.co2PerUserKg >= 1000
                                        ? `${formatCo2eTons(globalStats.co2PerUserKg)}${t('ton_short')}`
                                        : `${formatCo2e(globalStats.co2PerUserKg, 0)} ${t('kg')}`}`
                                    : '—'}
                            </div>
