...
export const metadata: Metadata = {
    ...
    description:
        'Personal PWA to log everyday activities and estimate CO₂e. Dashboard, optional Gemini tips, bilingual (en/ru).',
    keywords: [
        'carbon footprint',
        'CO2',
        'CO2e tracker',
    ...
    openGraph: {
        title: 'EcoTrackr — Personal CO₂e Tracker',
        description: 'Log activities and estimate CO₂e. Personal open-source PWA.',
        url: getSiteUrl(),
        siteName: 'EcoTrackr',
        images: [
            {
