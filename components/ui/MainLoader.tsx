    ...
    return (
        <div className="text-center" aria-busy="true">
            <div className="relative inline-block">
                ...
                <div className="absolute inset-0 w-20 h-20 border-4 border-emerald-600 rounded-full animate-spin border-t-transparent" />
                <Leaf className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 text-emerald-600 animate-pulse" />
            </div>
